...
We have barely touched the surface of what R has to offer. If you want to take your skills to the next level, here are some topics to investigate. However let us make this simple: you need to read ["R for Data Science"](http://r4ds.had.co.nz/).

### Books

["R for Data Science"](http://r4ds.had.co.nz/) by Garrett Grolemund and Hadley Wickham is a good modern introduction to R, and can be read online. This covers use of a collecition of packages called the [Tidyverse](https://www.tidyverse.org/). The [`dplyr`](http://dplyr.tidyverse.org/) package is of particular importance.

[Hadley Wickham](http://hadley.nz/) also has several excellent books covering specific topics online.
