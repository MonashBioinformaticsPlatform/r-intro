...
If we `plot` factors, shows the proportions of each level in the factor. We can also see that R uses the order of levels we gave it in the plot.
...
>
> Extension: How could we clean up the data frame so we never needed to use na.rm=TRUE?
>
